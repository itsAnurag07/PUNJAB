...
const Courses = () => {
    return (
        <div className="animate-fade-in">
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            ...
                            <div className="bg-cream-accent dark:bg-zinc-800 p-6 border-l-8 border-primary rounded-lg flex items-center gap-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-xl font-bold">New Batch Every Monday</p>
                                </div>
                            </div>
                            <div className="bg-cream-accent dark:bg-zinc-800 p-6 border-l-8 border-primary rounded-lg flex items-center gap-6">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        <div className="flex flex-col items-center text-center">
                            ...
                            <p className="text-white/80">Must hold a valid Commercial HMV/Transport License.</p>
                        </div>
                        <div className="flex flex-col items-center text-center">
            ...
            <section className="py-20 bg-white dark:bg-zinc-900">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-3xl font-black text-primary mb-12 uppercase tracking-tight">Documents Required</h2>
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                        <div className="bg-cream-accent dark:bg-zinc-800 p-8 rounded-xl border border-primary/10 flex flex-col items-center text-center">
                        ...
                        <div className="bg-cream-accent dark:bg-zinc-800 p-8 rounded-xl border border-primary/10 flex flex-col items-center text-center">
                            ...
                            <p className="font-bold">Medical Fitness</p>
                            <p className="text-xs text-zinc-500 mt-2">Form 1A Certified</p>
                        </div>
                    </div>
                </div>
            </section>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-center gap-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-2xl font-black">info@jidtjalandhar.com</p>
                                    </div>
                                </div>
                            </div>
                        </div>
