            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex justify-between items-end mb-12">
                    <div>
                        ...
                        <h3 className="text-4xl font-black text-slate-900 dark:text-white mt-2">Featured Courses</h3>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-7xl mx-auto">
                    ...
                    <div className="bg-background-light dark:bg-slate-800 rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all border border-slate-100 dark:border-slate-700">
                        <div className="h-64 bg-cover bg-center" data-alt="Hands on steering wheel of a modern truck" style={{ backgroundImage: "url('src/assets/Form5.png" }}></div>
                    ...
                    <div className="bg-background-light dark:bg-slate-800 rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all border border-slate-100 dark:border-slate-700">
                        <div className="h-64 bg-cover bg-center" data-alt="Eco-driving fuel efficiency icons" style={{ backgroundImage: "url('src/assets/Fuel Efficient.png" }}></div>
                        <div className="p-8 text-center">
